...
import BookingCard from '../../components/BookingCard.jsx'; // Assuming this component exists and is styled
...
export default function Bookings() {
  ...
  const renderContent = () => {
    ...
    if (filteredBookings.length === 0) {
      return (
        <div className="text-center text-muted p-5 card card-body bg-light">
          <h5>No {activeTab} bookings found.</h5>
        </div>
      );
    }
    // Assuming BookingCard is a styled component similar to TripCard
  ...
  return (
    <div>
      <h2 className="mb-4 fw-bold text-start">My Bookings</h2>
